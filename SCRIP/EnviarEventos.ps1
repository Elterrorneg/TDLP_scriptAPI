...
function Main {
    ...
    # URL para enviar los eventos de aplicación
    ...
    if ($responseAuth -ne $null -and $responseAuth.access_token -ne $null) {
        ...
        try {
            ...
            Write-Output "Respuesta de la API (aplicación): $responseApi"
        ...
        # Convertir eventos de instalación a JSON
        ...
        # Convertir eventos de seguridad a JSON
        ...
        Write-Output "Cuerpo de la solicitud de eventos (seguridad): $jsonBodySeguridad"

        # Enviar los datos de seguridad a la API
        try {
            ...
            Write-Output "Respuesta de la API (seguridad): $responseApi"
            [System.Windows.Forms.MessageBox]::Show("Datos de seguridad enviados correctamente")
        } catch {
            Write-Output "Error al enviar eventos de seguridad: $_"
            $errorContent = $_.Exception.Response.Content
            Write-Output "Detalles del error: $errorContent"
            [System.Windows.Forms.MessageBox]::Show("Error al enviar eventos de seguridad")
        }
